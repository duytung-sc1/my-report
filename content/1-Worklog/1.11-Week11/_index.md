...
* Learn AWS WAF and Shield for protection.
* Manage secrets using AWS Secrets Manager.
* Work with AWS Certificate Manager (ACM).
...
* Understood **advanced AWS security services**.
* Configured **AWS WAF and Shield protection**.
* Managed sensitive data with **Secrets Manager**.
* Implemented HTTPS using **Certificate Manager (ACM)**.
* Built a **secure production environment** using:
  * WAF
  * Shield
  * Secrets Manager
  * ACM
