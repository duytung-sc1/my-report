...
* Learn CloudWatch metrics, logs, and alarms.
* Explore CloudTrail for audit logging.
...
* Understood **monitoring and logging systems** in AWS.
* Configured **CloudWatch metrics, logs, and alarms**.
* Implemented **CloudTrail for auditing and tracking**.
* Used **AWS X-Ray for distributed tracing**.
* Built a **comprehensive monitoring setup** including:
  * CloudWatch
  * CloudTrail
  * X-Ray
